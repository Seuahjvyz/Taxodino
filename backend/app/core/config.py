...
class Settings:
    ...
    # Base de datos
    DATABASE_URL = os.getenv("NEON_DATABASE_URL", os.getenv("DATABASE_URL", "postgresql://user:pass@localhost/dbname"))
    
    # Llave secreta del API
    ...
    USER_AGENT = os.getenv("WIKIDATA_USER_AGENT", "TaxodinoApp/1.0 (https://github.com/tuusuario/taxodino; taxodino@ejemplo.com)")
